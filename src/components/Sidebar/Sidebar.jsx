...
export default function Sidebar() {
  return (
    <div className='md:w-2/5 sm:py-8 py-4 relative'>
      <h1 className='text-2xl font-bold text-dark ml-4 sm:ml-8'>General Statistics</h1>
      <div className="relative">
        <RegisteredUserChart header='Total New Registered Users' className="mt-5 px-4 sm:px-8 xl:min-w-[28rem] min-w-full h-48" />
      </div>
      <div className="relative mt-16 border-t-0.2 border-gray">
        <UserStatistics header='Users Statistics' className="mt-5 px-4 sm:px-8 xl:min-w-[28rem] min-w-full h-52" />
      </div>
